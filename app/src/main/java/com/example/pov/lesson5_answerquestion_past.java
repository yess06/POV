...
public class lesson5_answerquestion_past extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button78);

        exercise1 = findViewById(R.id.QspasL51);
        ...
        exercise2 = findViewById(R.id.QspasL52);
        ...
        exercise3 = findViewById(R.id.QspasL53);
        ...
        exercise4 = findViewById(R.id.QspasL54);
        ...
        exercise5 = findViewById(R.id.QspasL55);
        ...
        exercise6 = findViewById(R.id.QspasL56);
        ...
        exercise7 = findViewById(R.id.QspasL57);
        ...
        exercise8 = findViewById(R.id.QspasL58);
        ...
        exercise9 = findViewById(R.id.QspasL59);
        ...
        exercise10 = findViewById(R.id.QspasL510);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson5_answerquestion_past.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson5_answerquestion_past.this, "Qualification Max : 10.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson5_answerquestion_past.this, lesson5_qualification_past.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson5_answerquestion_past.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
