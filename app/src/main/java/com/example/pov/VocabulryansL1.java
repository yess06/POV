...
public class VocabulryansL1 extends AppCompatActivity {
    String id, token;
    Button btnsubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vocabulryans_l1);
        btnsubmit = findViewById(R.id.btnlessontwopreviewvocabulary2);
        exercise1 = findViewById(R.id.qspsL3);
        ...
        exercise2 = findViewById(R.id.qspsL4);
        ...
        exercise3 = findViewById(R.id.qspsL);
        ...
        exercise4 = findViewById(R.id.qspsL5);
        ...
        exercise5 = findViewById(R.id.qspsL6);
