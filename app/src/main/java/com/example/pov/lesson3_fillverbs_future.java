...
public class lesson3_fillverbs_future extends AppCompatActivity {
    ...
    Spinner exercise11, exercise12;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lesson3_fillverbs_future);
        btnsubmit = findViewById(R.id.button60);
        exercise1 = findViewById(R.id.fillfutL31);
        ...
        exercise2 = findViewById(R.id.fillfutL32);
        ...
        exercise3 = findViewById(R.id.fillfutL33);
        ...
        exercise4 = findViewById(R.id.fillfutL34);
        ...
        exercise5 = findViewById(R.id.fillfutL35);
        ...
        exercise6 = findViewById(R.id.fillfutL36);
        ...
        exercise7 = findViewById(R.id.fillfutL37);
        ...
        exercise8 = findViewById(R.id.fillfutL38);
        ...
        exercise9 = findViewById(R.id.fillfutL39);
        ...
        exercise10 = findViewById(R.id.fillfutL310);
        ...
        exercise11 = findViewById(R.id.fillfutL311);
        ...
        exercise12 = findViewById(R.id.fillfutL312);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson3_fillverbs_future.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson3_fillverbs_future.this, "Qualification Max : 10.00\nQualification Obt :" + fina, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(lesson3_fillverbs_future.this, lesson3_menu_tenses.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson3_fillverbs_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
