...
public class qualificationvocabulary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btntry = findViewById(R.id.button73);
    ...
    public void qualifilesson(View view){
        ...
        progressDialog = new ProgressDialog(qualificationvocabulary.this);
    ...
    public void quallificationlesson(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(qualificationvocabulary.this);
