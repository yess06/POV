...
public class lesson4_listenread_past extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson4_listenread_past);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.lesson4past);
    ...
    public void qualification(View view){
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(lesson4_listenread_past.this, lessons.class);
