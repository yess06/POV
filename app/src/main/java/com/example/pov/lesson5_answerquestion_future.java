...
public class lesson5_answerquestion_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exercise2 = findViewById(R.id.QsfutL52);
        ...
        exercise3 = findViewById(R.id.QsfutL53);
        ...
        exercise4 = findViewById(R.id.QsfutL54);
        ...
        exercise5 = findViewById(R.id.QsfutL55);
        ...
        exercise6 = findViewById(R.id.QsfutL56);
        ...
        exercise7 = findViewById(R.id.QsfutL57);
        ...
        exercise8 = findViewById(R.id.QsfutL58);
        ...
        exercise9 = findViewById(R.id.QsfutL59);
        ...
        exercise10 = findViewById(R.id.QsfutL510);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson5_answerquestion_future.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    progressDialog.hide();
                    Toast.makeText(lesson5_answerquestion_future.this, "Qualification Max : 10.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson5_answerquestion_future.this, lesson5_qualification_future.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.hide();
                    Toast.makeText(lesson5_answerquestion_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
