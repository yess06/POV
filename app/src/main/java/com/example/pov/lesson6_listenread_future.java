...
public class lesson6_listenread_future extends AppCompatActivity {
    String id, token;
    Button btnsubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson6_listenread_future);
        btnsubmit = findViewById(R.id.button46);
        playerPosition = findViewById(R.id.player_position);
        seekBar = findViewById(R.id.seekBar);
        btPlay = findViewById(R.id.btPlay);
        btPause = findViewById(R.id.bt_pause);

        mediaPlayer = MediaPlayer.create(this, R.raw.lesson6future);
    ...
    public void qualification(View view){
        ...
        progressDialog = new ProgressDialog(lesson6_listenread_future.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onErrorResponse(VolleyError error) {
                btnsubmit.setEnabled(true);
                progressDialog.hide();
                Toast.makeText(lesson6_listenread_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
