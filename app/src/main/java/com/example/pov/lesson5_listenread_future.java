...
public class lesson5_listenread_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson5_listenread_future);
        btnsubmit = findViewById(R.id.button44);
        playerPosition = findViewById(R.id.player_position);
        seekBar = findViewById(R.id.seekBar);
        btPlay = findViewById(R.id.btPlay);
        btPause = findViewById(R.id.bt_pause);

        mediaPlayer = MediaPlayer.create(this, R.raw.lesson5future);
    ...
    public void qualification(View view){
        ...
        progressDialog = new ProgressDialog(lesson5_listenread_future.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(lesson5_listenread_future.this, lesson5_menu_tenses.class);
