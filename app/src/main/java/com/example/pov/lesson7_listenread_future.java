...
public class lesson7_listenread_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.lesson7future);
    ...
    public void qualification(View view){
        ...
        progressDialog = new ProgressDialog(lesson7_listenread_future.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                progressDialog.hide();
                Toast.makeText(lesson7_listenread_future.this, "Qualification Max : 15.00\nQualification Obt : 15.00",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(lesson7_listenread_future.this, lesson7_menu_tenses.class);
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hide();
                Toast.makeText(lesson7_listenread_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
