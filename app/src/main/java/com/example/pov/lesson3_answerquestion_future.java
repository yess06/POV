...
public class lesson3_answerquestion_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button59);
        ...
        exercise1 = findViewById(R.id. QsfutL31);
        ...
        exercise2 = findViewById(R.id.QsfutL32);
        ...
        exercise3 = findViewById(R.id.QsfutL33);
        ...
        exercise4 = findViewById(R.id.QsfutL34);
        ...
        exercise5 = findViewById(R.id.QsfutL35);
        ...
        exercise6 = findViewById(R.id. QsfutL36);
        ...
        exercise7 = findViewById(R.id. QsfutL37);
        ...
        exercise8 = findViewById(R.id. QsfutL38);
        ...
        exercise9 = findViewById(R.id. QsfutL39);
        ...
        exercise10 = findViewById(R.id. QsfutL310);
    ...
    public void qualification(){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson3_answerquestion_future.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson3_answerquestion_future.this, "Qualification Max : 10.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson3_answerquestion_future.this, lesson3_qualification_future.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson3_answerquestion_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
