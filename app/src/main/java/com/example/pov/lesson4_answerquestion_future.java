...
public class lesson4_answerquestion_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button65);

        exercise1 = findViewById(R.id.QsfutL41);
        ...
        exercise2 = findViewById(R.id.QsfutL42);
        ...
        exercise3 = findViewById(R.id.QsfutL43);
        ...
        exercise4 = findViewById(R.id.QsfutL44);
        ...
        exercise5 = findViewById(R.id.QsfutL45);
        ...
        exercise6 = findViewById(R.id.QsfutL46);
        ...
        exercise7 = findViewById(R.id.QsfutL47);
        ...
        exercise8 = findViewById(R.id.QsfutL48);
        ...
        exercise9 = findViewById(R.id.QsfutL49);
        ...
        exercise10 = findViewById(R.id.QsfutL410);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson4_answerquestion_future.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson4_answerquestion_future.this, "Qualification Max : 10.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson4_answerquestion_future.this, lesson4_qualification_future.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson4_answerquestion_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
