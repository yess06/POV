...
public class lesson2_qualification_lesson extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson2_qualification_lesson);
        score  = findViewById(R.id.scorequal5);
    ...
    public void qualifilesson(){
        ...
        progressDialog = new ProgressDialog(lesson2_qualification_lesson.this);
    ...
    public void quallificationlesson(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson2_qualification_lesson.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    btnsubmit.setVisibility(View.INVISIBLE);
                    progressDialog2.hide();
                    Toast.makeText(lesson2_qualification_lesson.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
                public Map getHeaders()throws AuthFailureError {
