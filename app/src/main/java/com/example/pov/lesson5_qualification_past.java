...
public class lesson5_qualification_past extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson5_qualification_past);
        score = findViewById(R.id.scorequal18);
    ...
    public void qualifitime(View view){
        ...
        progressDialog = new ProgressDialog(lesson5_qualification_past.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(lesson5_qualification_past.this, lessons.class);
    ...
    public void quallificationtime(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson5_qualification_past.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    progressDialog2.hide();
                    Toast.makeText(lesson5_qualification_past.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
                public Map getHeaders()throws AuthFailureError {
