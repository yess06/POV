...
public class lesson10PreviewVocabulary extends AppCompatActivity {
    String id, token;
    Button btnsubmit;
    double fin,fina;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.lesson10_preview_vocabulary);
        btnsubmit= findViewById(R.id.btnlessontwopreviewvocabulary3);
        exercise1 = findViewById(R.id.qspsL47);
        ...
        exercise2 = findViewById(R.id.qspsL48);
        ...
        exercise3 = findViewById(R.id.qspsL49);
        ...
        exercise4 = findViewById(R.id.qspsL50);
        ...
        exercise5 = findViewById(R.id.qspsL51);
    ...
    public void postqualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            if (exercise3.getSelectedItemPosition() == 5){
                cont++;
            }
            ...
            progressDialog = new ProgressDialog(lesson10PreviewVocabulary.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson10PreviewVocabulary.this, "Score: " + fina, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson10PreviewVocabulary.this, lessons.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson10PreviewVocabulary.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
