...
public class lesson9ListenreadPresent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button51);
    ...
    public void qualification(View view){
        ...
        progressDialog = new ProgressDialog(lesson9ListenreadPresent.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                progressDialog.hide();
                Toast.makeText(lesson9ListenreadPresent.this, "Qualification Max : 10.00\nQualification Obt : 10.00",Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(lesson9ListenreadPresent.this, lesson9MenuTenses.class);
            ...
            public void onErrorResponse(VolleyError error) {
                btnsubmit.setEnabled(true);
                progressDialog.hide();
                Toast.makeText(lesson9ListenreadPresent.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
