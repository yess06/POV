...
public class lesson7_answerquestion_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button83);
    ...
    public void qualification(){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson7_answerquestion_future.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson7_answerquestion_future.this, "Qualification Max : 15.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson7_answerquestion_future.this, lesson7_qualification_future.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson7_answerquestion_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
