...
public class lesson6_qualification_lesson extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson6_qualification_lesson);
        btnsubmit = findViewById(R.id.btnlessontwoactivities);
        btntry = findViewById(R.id.button111);
        score =  findViewById(R.id.scorequal36);
    ...
    public void qualifilesson(View view){
        ...
        progressDialog = new ProgressDialog(lesson6_qualification_lesson.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(lesson6_qualification_lesson.this, lessons.class);
    ...
    public void quallificationlesson(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson6_qualification_lesson.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    btnsubmit.setVisibility(View.INVISIBLE);
                    progressDialog2.hide();
                    Toast.makeText(lesson6_qualification_lesson.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
                public Map getHeaders()throws AuthFailureError {
