...
public class lesson5_qualification_present extends AppCompatActivity {
    String id, token;
    ...
    public void qualifitime(View view){
        ...
        progressDialog = new ProgressDialog(lesson5_qualification_present.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(lesson5_qualification_present.this, lessons.class);
    ...
    public void quallificationtime(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson5_qualification_present.this);
