...
public class lesson9PreviewVocabulary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exercise2 = findViewById(R.id.qspsL43);
        ...
        exercise3 = findViewById(R.id.qspsL44);
        ...
        exercise4 = findViewById(R.id.qspsL45);
        ...
        exercise5 = findViewById(R.id.qspsL46);
    ...
    public void postqualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            if (exercise2.getSelectedItemPosition() == 4){
                cont++;
            }
