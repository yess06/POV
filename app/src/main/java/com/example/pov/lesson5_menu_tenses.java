...
public class lesson5_menu_tenses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        }else if(valid.getInt("cont11", 0) == 1){
            btnVocabulary.setEnabled(false);
            btnPresent.setEnabled(true);
            btnPast.setEnabled(false);
            btnFuture.setEnabled(false);
            btnQualification.setEnabled(false);
        }else if(valid.getInt("cont11", 0) == 2){
            btnVocabulary.setEnabled(false);
            btnPresent.setEnabled(false);
            btnPast.setEnabled(true);
            btnFuture.setEnabled(false);
            btnQualification.setEnabled(false);
        }else if(valid.getInt("cont11", 0) == 3){
            btnVocabulary.setEnabled(false);
            btnPresent.setEnabled(false);
            btnPast.setEnabled(false);
            btnFuture.setEnabled(true);
            btnQualification.setEnabled(false);
        }else if(valid.getInt("cont11", 0) == 4){
            btnVocabulary.setEnabled(false);
            btnPresent.setEnabled(false);
            btnPast.setEnabled(false);
            btnFuture.setEnabled(false);
        ...
        btnPresent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(lesson5_menu_tenses.this, lesson5_menu_activities_present.class);
        ...
        btnPast.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(lesson5_menu_tenses.this, lesson5_menu_activities_past.class);
                startActivity(intent);
            }
        });
        ...
        btnFuture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(lesson5_menu_tenses.this, lesson5_menu_activities_future.class);
                startActivity(intent);
            }
        });
        ...
        btnVocabulary.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(lesson5_menu_tenses.this, lesson5_menu_vocabulary.class);
                startActivity(intent);
            }
        });
    ...
    public void getbtn() {
        ...
        try {
            progressDialog = new ProgressDialog(lesson5_menu_tenses.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                            ...
                            if (u.getString("user_id").equals(preferences.getString("id", "null"))){
                                if (u.getString("lesson_id").equals("5")){
                                    if (u.getString("time_id").equals("4")){
                                        ...
                                        editor.putInt("lesson5future", cont);
                                        editor.commit();
                                    }else if (u.getString("time_id").equals("3")){
                                        cont2++;
                                        SharedPreferences vali = getSharedPreferences("vali", Context.MODE_PRIVATE);
                                        SharedPreferences.Editor editor = vali.edit();
                                        editor.putInt("lesson5past", cont2);
                                        editor.commit();
                                    }
                                        ...
                                        SharedPreferences vali = getSharedPreferences("vali", Context.MODE_PRIVATE);
                                        SharedPreferences.Editor editor = vali.edit();
                                        editor.putInt("lesson5present", cont3);
                                        editor.commit();
                                    }
                                }
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson5_menu_tenses.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
