...
public class lesson3_answer_vocabulary extends AppCompatActivity {
    String url = "http://quizlet.com/_7vg22a";
    String id, token;
    @Override
    ...
    public void postqualification(View view){
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                Toast.makeText(lesson3_answer_vocabulary.this, "Score: 10.0", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(lesson3_answer_vocabulary.this, lessons.class);
                startActivity(intent);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(lesson3_answer_vocabulary.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
            }
        }){
            @Override
