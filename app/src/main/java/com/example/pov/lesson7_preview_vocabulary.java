...
public class lesson7_preview_vocabulary extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson7_preview_vocabulary);
        btnsubmit = findViewById(R.id.btnlessontwopreviewvocabulary6);
        exercise1 = findViewById(R.id.qspsL32);
        ...
        exercise2 = findViewById(R.id.qspsL33);
        ...
        exercise3 = findViewById(R.id.qspsL34);
        ...
        exercise4 = findViewById(R.id.qspsL35);
        ...
        exercise5 = findViewById(R.id.qspsL36);
    ...
    public void postqualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson7_preview_vocabulary.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson7_preview_vocabulary.this, "Score: " + fina, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson7_preview_vocabulary.this, lessons.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson7_preview_vocabulary.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
