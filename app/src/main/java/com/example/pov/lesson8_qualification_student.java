...
public class lesson8_qualification_student extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson8_qualification_student);
    ...
    public void showqualifiactionlesson1(){
        ...
        try {
            progressDialog = new ProgressDialog(lesson8_qualification_student.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.hide();
                    Toast.makeText(lesson8_qualification_student.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
