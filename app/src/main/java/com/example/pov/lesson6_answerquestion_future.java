...
public class lesson6_answerquestion_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button72);
        ...
        exercise1 = findViewById(R.id.QsfutL61);
        ...
        exercise2 = findViewById(R.id.QsfutL62);
        ...
        exercise3 = findViewById(R.id.QsfutL63);
        ...
        exercise4 = findViewById(R.id.QsfutL64);
        ...
        exercise5 = findViewById(R.id.QsfutL65);
        ...
        exercise6 = findViewById(R.id.QsfutL66);
        ...
        exercise7 = findViewById(R.id.QsfutL67);
        ...
        exercise8 = findViewById(R.id.QsfutL68);
        ...
        exercise9 = findViewById(R.id.QsfutL69);
        ...
        exercise10 = findViewById(R.id.QsfutL610);
    ...
    public void qualification(){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson6_answerquestion_future.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson6_answerquestion_future.this, "Qualification Max : 15.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson6_answerquestion_future.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
