...
public class lesson10qualificationlesson extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson10qualificationlesson);
        btnsubmit = findViewById(R.id.btnlessontwoactivities);
        score = findViewById(R.id.scorequal31);
        btntry = findViewById(R.id.button119);
    ...
    public void qualifilesson(View view){
        ...
        progressDialog = new ProgressDialog(lesson10qualificationlesson.this);
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
            ...
            public void onResponse(JSONObject response) {
                ...
                Intent intent = new Intent(lesson10qualificationlesson.this, lessons.class);
    ...
    public void quallificationlesson(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson10qualificationlesson.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    btnsubmit.setVisibility(View.INVISIBLE);
                    progressDialog2.hide();
                    Toast.makeText(lesson10qualificationlesson.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
                public Map getHeaders()throws AuthFailureError {
