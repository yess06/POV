...
public class lesson5_qualification_future extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = findViewById(R.id.scorequal16);
    ...
    public void qualifitime(View view){
        ...
        progressDialog = new ProgressDialog(lesson5_qualification_future.this);
    ...
    public void quallificationtime(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson5_qualification_future.this);
