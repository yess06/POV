...
public class lesson9qualificationpast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson9qualificationpast);
        score = findViewById(R.id.scorequal28);
        btnsubmit = findViewById(R.id.btnActivitiesFill);
        btntry = findViewById(R.id.button122);
    ...
    public void quallificationtime(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson9qualificationpast.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    progressDialog2.hide();
                    Toast.makeText(lesson9qualificationpast.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
                public Map getHeaders()throws AuthFailureError {
