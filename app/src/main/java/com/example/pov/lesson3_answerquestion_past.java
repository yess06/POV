...
public class lesson3_answerquestion_past extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button58);
        exercise1 = findViewById(R.id. QspasL31);
        ...
        exercise2 = findViewById(R.id. QspasL32);
        ...
        exercise3 = findViewById(R.id. QspasL33);
        ...
        exercise4 = findViewById(R.id. QspasL34);
        ...
        exercise5 = findViewById(R.id. QspasL35);
        ...
        exercise6 = findViewById(R.id. QspasL36);
        ...
        exercise7 = findViewById(R.id. QspasL37);
        ...
        exercise8 = findViewById(R.id. QspasL38);
        ...
        exercise9 = findViewById(R.id. QspasL39);
        ...
        exercise10 = findViewById(R.id. QspasL310);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson3_answerquestion_past.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson3_answerquestion_past.this, "Qualification Max : 10.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson3_answerquestion_past.this, lesson3_qualification_past.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson3_answerquestion_past.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
