...
public class lesson2_preview_vocabulary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exercise2 = findViewById(R.id.qspsL8);
        ...
        exercise3 = findViewById(R.id.qspsL9);
        ...
        exercise4 = findViewById(R.id.qspsL10);
        ...
        exercise5 = findViewById(R.id.qspsL11);
    ...
    public void postqualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson2_preview_vocabulary.this);
