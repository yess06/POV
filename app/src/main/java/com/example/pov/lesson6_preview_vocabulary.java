...
public class lesson6_preview_vocabulary extends AppCompatActivity {
    String id, token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lesson6_preview_vocabulary);
        exercise1 = findViewById(R.id.qspsL27);
        ...
        exercise2 = findViewById(R.id.qspsL28);
        ...
        exercise3 = findViewById(R.id.qspsL29);
        ...
        exercise4 = findViewById(R.id.qspsL30);
        ...
        exercise5 = findViewById(R.id.qspsL31);
    ...
    public void postqualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson6_preview_vocabulary.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    progressDialog.hide();
                    Toast.makeText(lesson6_preview_vocabulary.this, "Score: " + fina, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson6_preview_vocabulary.this, lessons.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    progressDialog.hide();
                    Toast.makeText(lesson6_preview_vocabulary.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
