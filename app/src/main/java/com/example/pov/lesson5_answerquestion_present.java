...
public class lesson5_answerquestion_present extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button79);
        exercise1 = findViewById(R.id.QspsL51);
        ...
        exercise2 = findViewById(R.id.QspsL52);
        ...
        exercise3 = findViewById(R.id.QspsL53);
        ...
        exercise4 = findViewById(R.id.QspsL54);
        ...
        exercise5 = findViewById(R.id.QspsL55);
        ...
        exercise6 = findViewById(R.id.QspsL56);
        ...
        exercise7 = findViewById(R.id.QspsL57);
        ...
        exercise8 = findViewById(R.id.QspsL58);
        ...
        exercise9 = findViewById(R.id.QspsL59);
        ...
        exercise10 = findViewById(R.id.QspsL510);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson5_answerquestion_present.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson5_answerquestion_present.this, "Qualification Max : 10.00\nQualification Obt :" + fina,Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson5_answerquestion_present.this, lesson5_qualification_present.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson5_answerquestion_present.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
