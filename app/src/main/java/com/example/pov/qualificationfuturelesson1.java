...
public class qualificationfuturelesson1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.btnScoreAnswfuture);
        btntry = findViewById(R.id.button62);
    ...
    public void qualifitime(View view){
        ...
        progressDialog = new ProgressDialog(qualificationfuturelesson1.this);
    ...
    public void quallificationtime(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(qualificationfuturelesson1.this);
