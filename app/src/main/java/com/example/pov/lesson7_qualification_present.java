...
public class lesson7_qualification_present extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        score = findViewById(R.id.scorequal22);
    ...
    public void qualifitime(){
        ...
        progressDialog = new ProgressDialog(lesson7_qualification_present.this);
    ...
    public void quallificationtime(){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
        try {
            progressDialog2 = new ProgressDialog(lesson7_qualification_present.this);
