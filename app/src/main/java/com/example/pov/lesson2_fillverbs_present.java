...
public class lesson2_fillverbs_present extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button16);
        exercise1 = findViewById(R.id.fill1);
        ...
        exercise2 = findViewById(R.id.fill2);
        ...
        exercise3 = findViewById(R.id.fill3);
        ...
        exercise4 = findViewById(R.id.fill4);
        ...
        exercise5 = findViewById(R.id.fill5);
        ...
        exercise6 = findViewById(R.id.fill6);
        ...
        exercise7 = findViewById(R.id.fill7);
        ...
        exercise8 = findViewById(R.id.fill8);
        ...
        exercise9 = findViewById(R.id.fill9);
        ...
        exercise10 = findViewById(R.id.fill10);
        ...
        exercise11 = findViewById(R.id.fill11);
        ...
        exercise12 = findViewById(R.id.fill12);
        ...
        exercise13 = findViewById(R.id.fill13);
        ...
        exercise14 = findViewById(R.id.fill14);
        ...
        exercise15 = findViewById(R.id.fill15);
        ...
        exercise16 = findViewById(R.id.fill16);
        ...
        exercise17 = findViewById(R.id.fill17);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson2_fillverbs_present.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson2_fillverbs_present.this, "Qualification Max : 10.00\nQualification Obt :" + fina, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(lesson2_fillverbs_present.this, lesson2_menu_tenses.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson2_fillverbs_present.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
