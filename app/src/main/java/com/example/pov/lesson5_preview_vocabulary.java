...
public class lesson5_preview_vocabulary extends AppCompatActivity {
    String id, token;
    Button btnsubmit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exercise2 = findViewById(R.id.qspsL23);
        ...
        exercise3 = findViewById(R.id.qspsL24);
        ...
        exercise4 = findViewById(R.id.qspsL25);
        ...
        exercise5 = findViewById(R.id.qspsL26);
    ...
    public void postqualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            if (exercise4.getSelectedItemPosition() == 5){
                cont++;
            }
            ...
            progressDialog = new ProgressDialog(lesson5_preview_vocabulary.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson5_preview_vocabulary.this, "Score: " + fina, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(lesson5_preview_vocabulary.this, lessons.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson5_preview_vocabulary.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
