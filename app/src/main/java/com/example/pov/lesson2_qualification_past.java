...
public class lesson2_qualification_past extends AppCompatActivity {
    String id, token;
    ...
    public void quallificationtime(){
        ...
        try {
            progressDialog2 = new ProgressDialog(lesson2_qualification_past.this);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(com.android.volley.Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    progressDialog2.hide();
                    Toast.makeText(lesson2_qualification_past.this, "Wrong data", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
    ...
    public void qualifitime(){
        ...
        progressDialog = new ProgressDialog(lesson2_qualification_past.this);
