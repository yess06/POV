...
public class lesson9FillverbsFuture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsubmit = findViewById(R.id.button91);
    ...
    public void qualification(View view){
        if(exercise1.getSelectedItemPosition() ==0||exercise2.getSelectedItemPosition() ==0||exercise3.getSelectedItemPosition() ==0
            ...
            progressDialog = new ProgressDialog(lesson9FillverbsFuture.this);
            ...
            JsonObjectRequest objectRequest = new JsonObjectRequest(com.android.volley.Request.Method.POST, url,
                ...
                public void onResponse(JSONObject response) {
                    ...
                    progressDialog.hide();
                    Toast.makeText(lesson9FillverbsFuture.this, "Qualification Max : 10.00\nQualification Obt :" + fina, Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(lesson9FillverbsFuture.this, lesson9MenuTenses.class);
                ...
                public void onErrorResponse(VolleyError error) {
                    btnsubmit.setEnabled(true);
                    progressDialog.hide();
                    Toast.makeText(lesson9FillverbsFuture.this, "Wrong with the qualification", Toast.LENGTH_SHORT).show();
                }
            }){
                @Override
